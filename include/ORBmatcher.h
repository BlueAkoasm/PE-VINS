...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        /**********************lcx***********************/
        bool inBorder(const cv::Point2f &pt, cv::Mat img);
        void EdgeMatchForTracking(Frame &LastFrame, Frame &CurrentFrame);
        void EdgeMatchForKeyFrame(KeyFrame* pKF1, KeyFrame* pKF2);
    public:
